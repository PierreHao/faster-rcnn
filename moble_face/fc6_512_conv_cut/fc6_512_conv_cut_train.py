...
def test_func(caffemodel):
    p=multiprocessing.Process(target=fddb_test.run,args=(caffemodel, net_name, 'test.prototxt'))
    p.start()
    #p.join()
...
if __name__ == '__main__':
    ...
    for i,pretrained_model in enumerate(stage):
        ...
        train_net_face(solver, roidb, output_dir,test_func,
