...
def format_rst(im, boxs, scores,thresh=CONF_THRESH):
    im_scale=1
    boxs=boxs.tolist()
...
if __name__ == '__main__':
    ...
    if save_rst:
        os.system('cd /home/yzh/Documents/caffe_workspace/py-faster-rcnn/data/fddb/evaluation;'
                  ...
                  'cp rstDiscROC.txt %s_%d_%d.txt' % (exp_name, INPUT_SIZE, RPN_POST_NUM))
        f = open('/home/yzh/Documents/caffe_workspace/py-faster-rcnn/data/fddb/%s_%d_%d.txt' % (
        exp_name, INPUT_SIZE, RPN_POST_NUM))
